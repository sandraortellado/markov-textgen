$(function(){
	...
	$('#profilecardname').text('I Love Trees');
	$('#profilecarduid').text('@Donald_TreeHugger');
	...
	function tweetitem($taval)
	{
		return '<li class="tweetcontainer">'+
					'<img class="tweetprofimg" src="https://grist.files.wordpress.com/2017/03/donniedrawing.jpg?w=1024&h=576&crop=1">'+
					'<span class="tweetprofname">'+'I Love Trees'+'</span>'+
					'<span class="tweetprofuid">'+'@Donald_TreeHugger'+'</span>'+
					'<div class="ml58px">'+
